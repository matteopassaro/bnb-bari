    ...
    <section className="relative h-[85vh] min-h-[600px] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto">
        <p className="text-primary-foreground/80 text-sm uppercase tracking-[0.3em] mb-4 font-sans font-medium">
          B&B nel cuore di Bari
        </p>
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-serif font-bold text-primary-foreground mb-6 leading-tight">
          Scopri Bari,<br />sentiti a casa
        </h1>
        <p className="text-primary-foreground/80 text-lg md:text-xl font-sans font-light mb-10 max-w-2xl mx-auto">
          Un angolo di pace nella città vecchia. Camere con vista, colazione pugliese e l'ospitalità del Sud.
        </p>
